...
/******************************************************************************/
#define AI_HAR_MODEL_NAME          "har"
#define AI_HAR_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_HAR_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HAR_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HAR_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HAR_IN_NUM        (1)

AI_DEPRECATED
#define AI_HAR_IN \
  ai_har_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_IN_SIZE { \
  AI_HAR_IN_1_SIZE, \
}
#define AI_HAR_IN_SIZE_BYTES { \
  AI_HAR_IN_1_SIZE_BYTES, \
}
#define AI_HAR_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_HAR_IN_1_HEIGHT      (26)
#define AI_HAR_IN_1_CHANNEL     (3)
#define AI_HAR_IN_1_SIZE        (26 * 3)
#define AI_HAR_IN_1_SIZE_BYTES  (312)

/******************************************************************************/
#define AI_HAR_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HAR_OUT \
  ai_har_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_OUT_SIZE { \
  AI_HAR_OUT_1_SIZE, \
}
#define AI_HAR_OUT_SIZE_BYTES { \
  AI_HAR_OUT_1_SIZE_BYTES, \
}
#define AI_HAR_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_HAR_OUT_1_CHANNEL     (3)
#define AI_HAR_OUT_1_SIZE        (3)
#define AI_HAR_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_HAR_N_NODES (8)
 ...
 * @ref ai_har_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_HAR_*
 * defines into file @ref har.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
